...
const EditUser = () => {
    ...
    const handleEdit = e => {
        ...
        const url = `http://localhost:5000/edit-user/${userInfo._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
    ...
    return (
        <>
            ...
            <form onSubmit={handleEdit} className="mx-auto w-[70%] mt-10">
                <div className='flex flex-col items-center'>
                    <h1 className='lg:mt-4 text-center text-3xl my-4'>Edit the user</h1>
                </div>
